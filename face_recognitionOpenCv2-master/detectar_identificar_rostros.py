...
eyeCascade = cv2.CascadeClassifier("D:/Sandra/UNIVERSIDAD/Seguridad Informatica/reconocimiento/Reconocimiento facial-Maldonado-Valencia-Camacho-Arancibia/face_recognitionOpenCv2-master/Cascades/haarcascade_eye.xml")
smileCascade = cv2.CascadeClassifier("D:/Sandra/UNIVERSIDAD/Seguridad Informatica/reconocimiento/Reconocimiento facial-Maldonado-Valencia-Camacho-Arancibia/face_recognitionOpenCv2-master/Cascades/haarcascade_smile.xml")
 
reconocimiento = cv2.face.LBPHFaceRecognizer_create()
reconocimiento.read("D:/Sandra/UNIVERSIDAD/Seguridad Informatica/reconocimiento\Reconocimiento facial-Maldonado-Valencia-Camacho-Arancibia/face_recognitionOpenCv2-master/entrenamiento.yml")
